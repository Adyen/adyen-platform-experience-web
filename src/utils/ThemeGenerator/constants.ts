...
export const SEMANTIC_MAPPINGS: SemanticMapping[] = [
    ...
    { variable: 'color-label-inverse-disabled', category: 'label', step: 70 },
    ...
    { variable: 'color-label-always-light-secondary-active', category: 'label', step: 70 },
    { variable: 'color-label-always-light-tertiary', category: 'label', step: 50 },
    { variable: 'color-label-always-light-tertiary-hover', category: 'label', step: 70 },
