...
export const SEMANTIC_MAPPINGS: SemanticMapping[] = [
    ...
    { variable: 'color-background-secondary', category: 'neutral', fallback: 'background', step: 10 },
    { variable: 'color-background-secondary-hover', category: 'neutral', fallback: 'background', step: 20 },
    { variable: 'color-background-secondary-active', category: 'neutral', fallback: 'background', step: 30 },
    { variable: 'color-background-tertiary', category: 'neutral', fallback: 'background', step: 20 },
    { variable: 'color-background-tertiary-hover', category: 'neutral', fallback: 'background', step: 30 },
    { variable: 'color-background-tertiary-active', category: 'neutral', fallback: 'background', step: 30 },
    { variable: 'color-background-quaternary', category: 'neutral', fallback: 'background', step: 40 },
    { variable: 'color-background-quaternary-hover', category: 'neutral', fallback: 'background', step: 40 },
    { variable: 'color-background-quaternary-active', category: 'neutral', fallback: 'background', step: 50 },
    ...
    { variable: 'color-background-disabled', category: 'neutral', fallback: 'background', step: 20 },
    ...
    // Separator (neutral surface hierarchy; falls back to outline when neutral is omitted)
    { variable: 'color-separator-primary', category: 'neutral', fallback: 'outline', step: 30 },
    { variable: 'color-separator-secondary', category: 'neutral', fallback: 'outline', step: 40 },
    { variable: 'color-separator-inverse-primary', category: 'neutral', fallback: 'outline', step: 80 },
    { variable: 'color-separator-inverse-secondary', category: 'neutral', fallback: 'outline', step: 70 },
];
