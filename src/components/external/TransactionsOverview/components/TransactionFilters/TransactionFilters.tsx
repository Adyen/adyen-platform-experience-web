...
const TransactionsFilters = ({
    ...
    const [pspReference, setPspReference] = useState(initialFilters.current.pspReference);
    ...
    const currentFilters = useMemo(
        () => ({ balanceAccount, categories, createdDate, currencies, pspReference, statuses }) as const,
        [balanceAccount, categories, createdDate, currencies, statuses, pspReference]
    );
    ...
    const resetFilters = useCallback(() => {
        ...
        setPspReference(initialFilters.current.pspReference);
        ...
        >
            ...
            {isTransactionsView ? (
                <>
                    ...
                    />
                    <TransactionPspReferenceFilter eventCategory={eventCategory} onChange={setPspReference} value={pspReference} />
                </>
            ) : (
                <>
