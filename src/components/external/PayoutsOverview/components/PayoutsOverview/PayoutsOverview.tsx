...
>) => {
    ...
    return (
        <div className={BASE_CLASS}>
            <Header hideTitle={hideTitle} titleKey="payouts.overview.titleHeading.visible" subtitleKey="payouts.overview.generateInfo.visible">
            ...
            <DataDetailsModal
                ariaLabelKey="payouts.details.modal.label"
