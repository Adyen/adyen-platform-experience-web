export const GRANT_ITEM_CLASS_NAMES = {
    ...
    details: 'adyen-pe-grant-item__details',
    detailsContent: 'adyen-pe-grant-item__details-content',
    detailsHeader: 'adyen-pe-grant-item__details-header',
    detailsLabel: 'adyen-pe-grant-item__details-label',
