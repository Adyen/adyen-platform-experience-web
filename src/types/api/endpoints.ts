...
export type DownloadEndpoints = CSVEndpoints | 'downloadDefenseDocument';
type JSONEndpoints = Exclude<EndpointName, DownloadEndpoints>;

export type EndpointJSONData<T extends JSONEndpoints> = EndpointsOperations[T]['responses'][200]['content']['application/json'];

export type EndpointData<T extends EndpointName> = T extends DownloadEndpoints
