 ...
 */
import { RefundReason } from '../../../components/external/TransactionDetails/context/types';
...
export interface components {
    schemas: {
        ...
        RefundReason: 'requested_by_customer' | 'issue_with_item_sold' | 'fraudulent' | 'duplicate';
        /** @enum {string} */
