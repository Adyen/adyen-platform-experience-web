...
const DEFENDABLE_CHARGEBACK_REASONS: Record<string, Record<string, readonly IDisputeDefenseDocument[]>> = {
    '10.4': {
        ScanningError: [
            { documentTypeCode: 'AcquirerRetrievalFulfilmentForm', requirementLevel: 'REQUIRED' } as const,
            { documentTypeCode: 'AcquirerRepresentmentForm', requirementLevel: 'REQUIRED' } as const,
            { documentTypeCode: 'ChipTransactionReportedToSAFE', requirementLevel: 'REQUIRED' } as const,
            { documentTypeCode: 'InvalidChargeback', requirementLevel: 'OPTIONAL' } as const,
            { documentTypeCode: 'AcquirerRepresentmentForm', requirementLevel: 'OPTIONAL' } as const,
        ] as const,
...
export const CHARGEBACKS = [
    {
        ...
        reason: { category: 'CONSUMER_DISPUTE', code: '10.4', title: 'Cardholder dispute - Defective / Not as described' },
    ...
    },
    {
        ...
        createdAt: getDate(-9),
        paymentMethod: { type: 'visa', lastFourDigits: '0002', description: 'Visa' },
        reason: { category: 'PROCESSING_ERROR', code: '30', title: 'Cardholder/Seller dispute, cardholder/seller request for copy' },
        amount: { currency: 'USD', value: 222200 },
    },
    {
        ...
        reason: { category: 'ADJUSTMENT', code: '13.1', title: 'Merchandise/Services Not Received' },
    ...
    },
    {
        ...
        reason: { category: 'AUTHORISATION_ERROR', code: 'faulty_goods', title: 'The user reported that he/she received a faulty good' },
    ...
    },
    {
        ...
        reason: { category: 'OTHER', code: '4837', title: 'No Cardholder Authorisation' },
...
const ACCEPTABLE_CHARGEBACK_REASONS: IDisputeReasonCategory[] = ['CONSUMER_DISPUTE', 'FRAUD', 'PROCESSING_ERROR', 'REQUEST_FOR_INFORMATION'];
