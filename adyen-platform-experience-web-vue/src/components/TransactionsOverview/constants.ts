import type { TransactionsDateRange, TransactionsFilters, ITransactionCategory, ITransactionStatus, ITransaction, RangeTimestamps } from './types';
import { TransactionsView } from './types';
import * as RangePreset from './timerange';
...
} as const) as Readonly<Record<string, RangeTimestamps>>;
...
export const TRANSACTIONS_VIEW_TABS: readonly Readonly<{ id: TransactionsView; label: string; content: null }>[] = [
