...
export const TX_TABS_CONTAINER = `${TX_DATA_CLASS}__tabs-container`;

export const TX_DETAILS_TABS: readonly Readonly<{ id: DetailsTab; label: string; content: null }>[] = [
    { id: DetailsTab.SUMMARY, label: 'transactions.details.views.summary', content: null },
    { id: DetailsTab.DETAILS, label: 'transactions.details.views.details', content: null },
    { id: DetailsTab.TIMELINE, label: 'transactions.details.views.timeline', content: null },
] as const;

export const TX_DETAILS_FIELDS_REMAPS: Record<string, string | ((tx?: any) => string | undefined)> = {
    balanceAccount: 'account',
    balanceAccountId: (tx?: any) => {
...
export const TX_DETAILS_RESERVED_FIELDS_SET = new Set<string>([
    'status',
    'category',
    'paymentMethod',
    'bankAccount',
...
export const REFUND_STATUSES = ['completed', 'in_progress', 'failed'] as const;
export const REFUND_REASONS = ['requested_by_customer', 'issue_with_item_sold', 'fraudulent', 'duplicate', 'other'] as const;

export const REFUND_REASONS_KEYS: Record<string, string> = Object.freeze({
