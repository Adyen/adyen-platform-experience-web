...
export class SessionContext<T, HttpParams extends any[] = any[]> {
    ...
    declare public readonly http: typeof this._sessionHttp;
    declare public readonly on: (typeof this._eventEmitter)['on'];
    declare public readonly refresh: (typeof this._refresher)['refresh'];
