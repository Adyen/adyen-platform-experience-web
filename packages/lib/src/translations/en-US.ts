export default {
    ...
    type: 'Type',
    value: 'Value',
    weCouldNotLoadThePayoutsOverview: 'We could not load the payouts overview.',
    weCouldNotLoadTheTransactionsOverview: 'We could not load the transactions overview.',
    weCouldNotLoadYourBalanceAccounts: 'We couldn’t load your balance accounts.',
    weCouldNotLoadYourPayouts: 'We could not load your payouts.',
    weCouldNotLoadYourTransactions: 'We could not load your transactions.',
};
