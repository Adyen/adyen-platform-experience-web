...
describe('Checkbox', () => {
    ...
    test('Renders a checkbox with a label', () => {
        ...
        expect(wrapper.find('input[type="checkbox"]').prop('className')).toContain('adyen-fp-checkbox__input');
        expect(wrapper.find('input[type="checkbox"]').prop('value')).toBe('value');
        expect(wrapper.find('input[type="checkbox"]').prop('name')).toBe('name');
        expect(wrapper.find('span').prop('className')).toContain('adyen-fp-checkbox__label');
