...
const ListBoxControl = forwardRef(
    ({ expand, listBox, onSelection, render, state, ...props }: ListBoxControlProps, ref: ForwardedRef<HTMLButtonElement>) => {
        ...
        useEffect(() => {
            if (activeOption != undefined) onSelection(activeOption);
        }, [activeOption, onSelection]);
