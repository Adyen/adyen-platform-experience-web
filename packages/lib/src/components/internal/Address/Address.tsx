...
import { AddressData, AddressFieldsGroup, AddressProps } from './types';
...
export default function Address(props: AddressProps<AddressData>) {
     ...
     */
    const enabledFields: string[] = requiredFieldsSchema.filter(item => !iOSFocusedField || item === iOSFocusedField);
