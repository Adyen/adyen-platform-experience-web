...
import { BASE_CLASS, LOADING_CLASS, MARGIN_CLASS } from '@src/components/external/TransactionsOverview/components/AmountSkeleton/constants';
import './AmountSkeleton.scss';
import { FC } from 'preact/compat';
import { AmountSkeletonProps } from '@src/components/external/TransactionsOverview/components/AmountSkeleton/types';
