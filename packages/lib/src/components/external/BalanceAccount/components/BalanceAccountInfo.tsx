...
import Balances from '@src/components/external/BalanceAccount/components/Balances';
import useCoreContext from '@src/core/Context/useCoreContext';
import { BalanceAccount } from '@src/types';

export const BalanceAccountInfo = ({ balanceAccount }: { balanceAccount: BalanceAccount }) => {
