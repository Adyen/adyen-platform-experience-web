...
import { UserEvents } from '../EventDispatcher/eventDispatcher/user-events';
...
export const EventDispatcherContext = createContext<Partial<UserEvents>>(defaultUserEvents);
