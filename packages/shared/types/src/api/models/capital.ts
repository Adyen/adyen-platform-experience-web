...
import { components as capitalStateComponents } from '../resources/CapitalStateResourceV1';
...
export type ICreateGrantOfferRequest = Schema<capitalGrantOffersComponents, 'CreateGrantOfferRequestV2DTO'>;
