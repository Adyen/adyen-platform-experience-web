import { IGrantOfferResponseDTO, IGrantOffersResponseDTO } from '@integration-components/types';
import { uuid } from '@integration-components/utils';
import { REPAYMENT_TERMS, REPAYMENT_TERM_FULL, REPAYMENT_TERM_HALF, REPAYMENT_TERM_QUARTER } from '../../mock-data/capital';
