...
import { ICapitalState, IGrant, IGrantOfferResponseDTO, ButtonVariant } from '@integration-components/types';
...
export const CapitalOfferSummary = ({ grantOffer, capitalState, onBack, onFundsRequest, onContactSupport }: CapitalOfferSummaryProps) => {
    ...
    const getStructuredListItems = useCallback(
        ...
        [formatTermLabel, i18n, isEarlyRenewal, maximumRepaymentPeriodDate]
    );
    ...
    console.log({ grantOffer, currentSimplifiedGrant });
    ...
    const tabs = useMemo<TabProps<string>[]>(
        () =>
            [
                {
                    id: 'newLoan',
                    label: 'capital.offer.summary.tabs.newLoan',
                    content: (
                        <StructuredList
                ...
                {
                    id: 'currentLoan',
                    label: 'capital.offer.summary.tabs.currentLoan',
                    content: (
                        <>
                            <StructuredList
                                classNames="adyen-pe-capital-offer-summary__details"
