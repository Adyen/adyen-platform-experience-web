...
const getDefaultValidationMessages = (i18n: I18n): ValidationMessages => ({
    ...
    minLength: minLength => i18n.get('payByLink.creation.errors.minLength', { values: { minLength } }),
    maxLength: maxLength => i18n.get('payByLink.creation.errors.maxLength', { values: { maxLength } }),
});
